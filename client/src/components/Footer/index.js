    ...
    <Stack>
      <Stack direction="row" spacing="4" align="center" justify="center">
        <ButtonGroup variant="black" color="gray.200" {...props}>
          <IconButton
            as="a"
            href="https://github.com/scochran31"
            aria-label="GitHub"
            icon={<GoMarkGithub fontSize="20px" />}
          />
          <IconButton
            as="a"
            href="https://github.com/MEaston12"
            aria-label="GitHub"
            icon={<GoMarkGithub fontSize="20px" />}
          />
          <IconButton
            as="a"
            href="https://github.com/cpesar"
            aria-label="GitHub"
            icon={<GoMarkGithub fontSize="20px" />}
          />
          <IconButton
            as="a"
            href="https://github.com/mandahos"
            aria-label="GitHub"
            icon={<GoMarkGithub fontSize="20px" />}
          />
        </ButtonGroup>
